...
overall it feels more like open-space conference where you're welcome to talk to anyone.
...
- using genetic algorithms to determine speed and angle for a particle to leave "paper bag".
...
- using genetic algorithm to determine rules for simple cellular automata.
...
On a serious note, it was a great talk about thinking about problems in more declarative way to express your intent rather than computer instructions.
...
The talks covered variety of topics in different formats and they have to be watched rather than described.
